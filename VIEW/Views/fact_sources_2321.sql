...
create view [VIEW].[fact_sources_2321] as
...
--join [dbo].[datatestrun] dr on dr._dongle = result.Dongle_Id and result.yearmth = dr._yrmth and dr._fact = 't'
where result.[table] not in ( 'fact_agent_event', 'fact_queue_name'  ) 
and Dongle_Id = 2321
GO
